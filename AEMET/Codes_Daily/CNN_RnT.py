...
## Predict
history, pred, acc_train, acc_test = NN(neuron, nep=35, X_train=Xtrain, Y_train=Ytrain, X_test=Xtest, Y_test=Ytest, sample_size=sample_size)
...
plt.tight_layout()
plt.savefig('./CNN_Loss_Rn_{}_{}.eps'.format(neuron[0], neuron[1]))
...
plt.tight_layout()
plt.savefig('./CNN_Rn_{}_{}.eps'.format(neuron[0], neuron[1]))
...
## Predict
history, pred, acc_train, acc_test = NN(neuron, nep=35, X_train=Xtrain_PMP, Y_train=Ytrain, X_test=Xtest_PMP, Y_test=Ytest, sample_size=sample_size)
...
plt.legend(['train', 'test'], loc='upper right')
plt.tight_layout()
plt.savefig('./CNN_Loss_RnT_PMP_{}_{}.eps'.format(neuron[0], neuron[1]))
...
plt.suptitle('Weekly Fitting at LSC - Hall A')
plt.tight_layout()
plt.savefig('./CNN_RnT_PMP_{}_{}.eps'.format(neuron[0], neuron[1]))
