...
EAM = []
for it in range(25):
    history, pred, acc_train, acc_test, model = GRU_v2(neuron, 7, X_train, Y_train, X_test, Y_test, sample_size)
...
neuron = [52, 104]
show_errors_GRU(neuron, 7, Xtrainlist, Ytrain, Xtestlist, Ytest, arr_str, iterations=25, sample_size=sample_size, DF_mdnRnA=DF)
