...
class AEMET_GET:
    ...
    def connect(self, api_key, where, ID=''):
        if where == 'Data':
            url = 'https://opendata.aemet.es/opendata/api/valores/climatologicos/diarios/datos/fechaini/{}T00:00:00UTC/fechafin/{}T23:59:59UTC/estacion/{}/?api_key={}'.format(self.start, self.end, ID, api_key)
