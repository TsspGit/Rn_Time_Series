...
# Plot:
X = BCN_arima[['tmed', 'velmedia', 'presmed']]
Y = mdnRnA
print(X.head())
...
plt.xticks(range(X.shape[1]), [r'$\bar{V}$', r'$\bar{P}$', r'$\bar{T}$'])
plt.xlim([-1, X.shape[1]])
plt.ylim([0, 1])
#plt.xlabel('Features')
plt.ylabel('Relative Importance')
plt.savefig('../Figures/Variables_Importance2.eps', dpi=100)
plt.savefig('../Figures/Variables_Importance2.png', dpi=100)
plt.show()
